...
Rails.application.config.sorcery.submodules = [:external, :remember_me, :reset_password, :user_activation]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  config.external_providers = %i(twitter facebook vk google liveid)
  ...
  config.user_config do |user|
    ...
    # Default: `true`
    user.prevent_non_active_users_to_login = !Rails.env.development?
